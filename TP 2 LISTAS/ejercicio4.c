...
Lista rellenarLista(Lista listaNueva, int tamanio) {
    ...
    while (i <= tamanio) {
        ...
        printf("Ingrese un valor (entre -100.000 y 100.000) a la lista #%d: ", i);
...
int main() {
    ...
    printf("Tenga en cuenta que si se excede el tamanio maximo de la lista, solo se cargara hasta completar el mismo.\n\n");
    printf("Ingrese el tamanio de las listas (entre 0 y 100.000): ");
    int tamanio ;
    tamanio = leer_entero();
    if (tamanio == 0){
    ...
    printf("\n--- Ingrese los datos para la LISTA 1 ---\n");
    lista1 = rellenarLista(lista1, tamanio);

    Lista lista2 = l_crear();
    printf("\n--- Ingrese los datos para la LISTA 2 ---\n");
