...
int leer_entero() {
    ...
    while (!valido) {
        ...
        if (errno != 0 || *finptr != '\0' || numero > 100000 || numero < -100000) {
            printf("Entrada invalida. Intentelo de nuevo con un valor entero dentro del rango.\n");
        } else {
            valido = 1;
        }
    }
...
Lista rellenarListaRandom() {
    ...
    printf("Tamano de la lista (entre 1 y 100.000).\n\n");
    ...
    printf("Ingrese el valor minimo de los valores random (-100.000 a 100.000): \n");
    randomMin = leer_entero();
    printf("Ingrese el valor maximo de los valores random (-100.000 a 100.000): \n");
