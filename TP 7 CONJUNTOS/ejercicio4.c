...
// funcion que dado tres conjuntos, determina la propiedad de la transitividad
// si A es subconjunto de B, y B es subconjunto de C, entonces A es subconjunto de C
bool esTransitivo(Conjunto A, Conjunto B, Conjunto C) {
...
int main() {
    ...
    cargarConjunto(conjuntoC);
    printf("\n----------------\n");

    if (esTransitivo(conjuntoA, conjuntoB, conjuntoC)) {
        printf("La Ley de Transitividad se cumple.\n");
    } else {
        printf("La Ley de Transitividad no se cumple.\n");
    }
